...
func main() {
	...
	goth.UseProviders(
		facebook.New(
			"1434024407761899",                 // 👉 Replace this with your real App ID
			"43f419c89eca3a49850f35ee74ad35d5", // 👉 Replace with your App Secret
			"http://localhost:8080/auth/facebook/callback"),
		google.New("1434024407761899", "43f419c89eca3a49850f35ee74ad35d5", "http://localhost:8080/auth/google/callback", "email", "profile"),
	)
...
func sendConfirmationEmail(to string, link string) {
	...
	password := " rdip stjn kkwq xdvf" // ✅ App password (not Gmail login!)
